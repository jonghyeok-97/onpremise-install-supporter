 ...
 */
@FeignClient(name = "dockerHubFeignClient", url = DockerImageMetaDataFeignClient.DOCKER_IMAGE_INFO_URL)
public interface DockerImageMetaDataFeignClient {
    ...
    List<DockerImageMetaData> getDockerImage();
}